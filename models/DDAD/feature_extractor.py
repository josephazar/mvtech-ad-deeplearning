...
def domain_adaptation(unet, config, fine_tune, category):
    ...
    if fine_tune:      
        ...
        torch.save(frozen_feature_extractor.state_dict(), os.path.join(os.path.join(os.getcwd(), config.model.checkpoint_dir), category,f'feat0'))
        ...
        checkpoint = torch.load(os.path.join(os.path.join(os.getcwd(), config.model.checkpoint_dir), category, f'feat{config.model.DA_chp}'))#f'feat{config.model.DA_chp}'

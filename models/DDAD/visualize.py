...
def visualize(image, noisy_image, GT, pred_mask, anomaly_map, category, dataset) :
    for idx, img in enumerate(image):
        ...
        plt.savefig('results/{}/{}sample{}.png'.format(dataset,category,idx))
        plt.close()
        ...
        plt.title('heat map')
        plt.savefig('results/{}/{}sample{}heatmap.png'.format(dataset,category,idx))
        plt.close()
